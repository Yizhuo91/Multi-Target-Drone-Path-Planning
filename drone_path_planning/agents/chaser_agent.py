...
from drone_path_planning.models import ChaserGraphQNetwork


@tf.keras.utils.register_keras_serializable('dpp.agents', 'c_agent')
class ChaserAgent(DeepQNetworkAgent):
    def __init__(
        self,
