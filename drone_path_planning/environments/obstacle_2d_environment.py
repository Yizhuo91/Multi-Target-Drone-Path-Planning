...
class Obstacle2DEnvironment(VariableNumberAgentEnvironment):
    def __init__(
        self,
    ...
    def reset(self):
        ...
        self._obstacle_displacements = self._create_initial_obstacle_displacements(num_obstacles, center_x=center_x, center_y=center_y)
