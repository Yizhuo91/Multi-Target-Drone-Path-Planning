...
from drone_path_planning.utilities.constants import OBSTACLE_TARGET
...
from drone_path_planning.utilities.constants import TARGET_OBSTACLE
...
@tf.keras.utils.register_keras_serializable('dpp.models', 'c_gqn')
class ChaserGraphQNetwork(tf.keras.Model):
    def __init__(
        self,
    ...
    def _build_graph(self, inputs: Dict[str, tf.Tensor]) -> Graph:
        ...
        obstacle_target_edge_set = self._build_all_pairs_relative_displacement_edge_set(obstacle_relative_displacements, target_relative_displacements, obstacles, targets, OBSTACLE, TARGET)
        target_obstacle_edge_set = self._build_all_pairs_relative_displacement_edge_set(target_relative_displacements, obstacle_relative_displacements, targets, obstacles, TARGET, OBSTACLE)
        node_sets = {
        ...
        edge_sets = {
            ...
            OBSTACLE_TARGET: obstacle_target_edge_set,
            TARGET_OBSTACLE: target_obstacle_edge_set,
        }
