...
from drone_path_planning.agents import ChaserAgent
from drone_path_planning.environments import Obstacle2DEnvironment
...
class OneThreeChasersOneTargetObstacle2DScenario(Scenario):
    def create_trainer(self, save_dir: str, logs_dir: Optional[str] = None) -> Trainer:
        chaser_agent: ChaserAgent
        try:
        ...
        environment = Obstacle2DEnvironment(
            group_min_max_nums=group_min_max_nums,
            min_num_obstacles=0,
            max_num_obstacles=4096,
        )
        replay_buffer = ReplayBuffer()
        validation_environment = Obstacle2DEnvironment(
            group_min_max_nums=group_min_max_nums,
            min_num_obstacles=0,
            max_num_obstacles=4096,
        )
