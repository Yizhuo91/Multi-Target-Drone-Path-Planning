...
from drone_path_planning.environments import ObstacleEnvironment
...
class OneThreeChasersOneTargetObstacleScenario(Scenario):
    def create_trainer(self, save_dir: str, logs_dir: Optional[str] = None) -> Trainer:
        ...
        environment = ObstacleEnvironment(
            ...
            min_num_obstacles=0,
            max_num_obstacles=32768,
        )
        replay_buffer = ReplayBuffer()
        validation_environment = ObstacleEnvironment(
            group_min_max_nums=group_min_max_nums,
            min_num_obstacles=0,
            max_num_obstacles=32768,
        )
